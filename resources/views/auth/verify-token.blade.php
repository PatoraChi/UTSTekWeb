  ...
  <div class="p-5 bg-secondary bg-opacity-25 rounded shadow" style="width: 100%; max-width: 400px;">
      ...
      <form id="verifyForm">
          <div class="mb-3">
              ...
              <div id="errorMessage" class="text-danger mt-2 small" style="display:none;">Kode salah! Silakan coba lagi.</div>
          </div>
          ...
          <div id="resendWrapper" class="text-center mt-3 d-none">
